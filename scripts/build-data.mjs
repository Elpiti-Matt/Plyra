...
await build({ stdin: { contents: 'export * from "./src/data/roastery"; export * from "./src/data/depot"; export * from "./src/data/crossNotation"; export * from "./src/lib/graph"; export * from "./src/lib/io"; export * from "./src/lib/notation";', resolveDir: process.cwd() }, bundle: true, platform: "node", format: "esm", outfile: ".qa/data.mjs" });
...
const graphs={roastery:lib.makeRoastery(),depot:lib.makeDemo(),"cross-notation-ru":lib.makeCrossNotation("ru"),"cross-notation-en":lib.makeCrossNotation("en")};
const metrics={};
